...
function () {
  ...
  _createClass(GreenAudioPlayer, [{
    ...
    value: function pausePlayer(player) {
      var playPauseButton = player.parentElement.querySelector('.play-pause-btn');
...
//
  ...
  document.querySelector('.input-container').addEventListener('mouseover', searchOver);
  document.querySelector('.input-container').addEventListener('mouseout', searchOut);
});
...
function searchOver(e) {
  document.querySelector('.input-field').classList.remove('hidden');
}
// Searchbar function
function searchOut(e) {
  document.querySelector('.input-field').value = '';
  document.querySelector('.input-field').classList.add('hidden');
}
;
